pipeline{
    ...
    environment{
        ...
        SVC = "Ordering"
        PROJECT = "./src/Services/${SVC}/${SVC}.BackgroundTasks/${SVC}.BackgroundTasks.csproj"
        CHART_DIR = "./deploy/ordering-backgroundtasks"
        SONAR_PRO_KEY = "ordering-backgroundtasks-svc"
    }
    stages{
        stage("Sonar Test"){
            agent{
