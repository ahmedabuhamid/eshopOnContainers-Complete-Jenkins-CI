pipeline{
    ...
    environment{
        ...
        SVC = "Ordering"
        PROJECT = "./src/Services/${SVC}/${SVC}.API/${SVC}.API.csproj"
        UNIT_TEST_DIR = "./src/Services/${SVC}/${SVC}.UnitTests"
        CHART_DIR = "./deploy/ordering-api"
        SONAR_PRO_KEY = "ordering-api-svc"
    }
    stages{
        stage ("unit test"){
            agent{
            ...
            steps{
                    sh 'dotnet test ${UNIT_TEST_DIR} --logger:\"trx;LogFileName=unit.testresults\"'
